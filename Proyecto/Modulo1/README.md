...
For this example, I'll use `erl` and PIN-based auth.
    ...
    2> { Url, Token } = twittler:pin_auth("Ln8bXKoEY60gZPQ9wj0bCynfA", "dGTbJkUJlLNdKn2zX9iSykry8Xl3CHJ7DQwScKpFnLqkhjpEEa").
...
invocation of `pin_auth`.  2495284

    5> Auth = twittler:pin_auth("Ln8bXKoEY60gZPQ9wj0bCynfA", "dGTbJkUJlLNdKn2zX9iSykry8Xl3CHJ7DQwScKpFnLqkhjpEEa", "2357424468-w2o7Vbizvy6NThaqN74DWGeYJtEMzRrGZYA1Hbp", "1313698").
